...
pongg = PING_MSG if ALIVE_PIC else "ᴛᴏxɪᴄ X sᴘᴀᴍ"
RIZ_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/afaf9fe60aec47093a00a.jpg"
Alivemsg = ALIVE_MSG if ALIVE_MSG else "𝐓𝐨𝐱𝐢𝐜 𝗫 𝗦𝗽𝗮𝗺 𝗛𝗲𝗿𝗲."

rizoel = f"✯ {Alivemsg} ✯\n\n"
rizoel += f"═══════════════════\n"
rizoel += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.9.6`\n"
rizoel += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
rizoel += f"• **ᴛᴏxɪᴄXsᴘᴀᴍ ᴠᴇʀsɪᴏɴ**  : `{rizoelversion}`\n"
rizoel += f"═══════════════════\n\n"   
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await event.client.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/MID_NIGHT_WORLD"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/MID_NIGHT_WORLD")
        ],
        [
        Button.url("• ʀᴇᴘᴏ •", "https://github.com/TOXICBRAND/SpamBot")
        ]
        ]
        )
